                ...
                <td style="background-color: #eeeeee">
                    <div style="color: #000C12; margin: 4% 10% 2%; text-align: center;font-family: sans-serif">
                        ...
                        <div style="width: 100%; text-align: center; margin: 40px auto;">
                            <a style="text-decoration: none; border-radius: 5px; padding: 11px 23px; color: white; background-color: #32A78A;" href="http://localhost:3000/user/newemail?token=' . $this->token . '"><span style="font-weight: bold;">Cambiar Email</span></a>
                        </div>
